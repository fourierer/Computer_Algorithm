...
#### 1.二叉树的三序遍历，递归与非递归，实际上树的DFS遍历就是先序遍历
...
背包问题分为0-1背包，多重背包和完全背包：

```c++
/*
1.0-1背包问题是指每一种物品都只有一件，可以选择放或者不放；
2.多重背包问题限定了一种物品的个数，解决多重背包问题，只需要把它转化为0-1背包问题即可。比如，有2件价值为5，重量为2的同一物品，我们就可以分为物品a和物品b，a和b的价值都为5，重量都为2，但我们把它们视作不同的物品；
3.完全背包问题是指每种物品都有无限件。
*/
```

0-1背包问题：leetcode 474一零和，leetcode 494目标和。

完全背包问题：leetcode 322零钱兑换，leetcode 518零钱兑换II
